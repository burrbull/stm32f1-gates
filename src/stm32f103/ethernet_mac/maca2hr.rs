...
#[doc = r" Proxy"]
pub struct _ETH_MACA2HRW<'a> {
    w: &'a mut W,
}
impl<'a> _ETH_MACA2HRW<'a> {
...
impl R {
    ...
    #[inline]
    pub fn eth_maca2hr(&self) -> ETH_MACA2HRR {
        let bits = {
            const MASK: u16 = 65535;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bits 0:15 - Ethernet MAC address 2 high register"]
    #[inline]
    pub fn eth_maca2hr(&mut self) -> _ETH_MACA2HRW {
        _ETH_MACA2HRW { w: self }
    }
    #[doc = "Bits 24:29 - Mask byte control"]
    #[inline]
