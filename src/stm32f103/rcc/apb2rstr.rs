...
#[doc = "Possible values of the field `ADC2RST`"]
pub type ADC2RSTR = AFIORSTR;
...
pub type TIM8RSTR = AFIORSTR;
#[doc = "Possible values of the field `USART1RST`"]
pub type USART1RSTR = AFIORSTR;
#[doc = "Possible values of the field `ADC3RST`"]
pub type ADC3RSTR = AFIORSTR;
...
#[doc = "Values that can be written to the field `ADC2RST`"]
pub type ADC2RSTW = AFIORSTW;
#[doc = r" Proxy"]
...
impl<'a> _ADC2RSTW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: ADC2RSTW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
#[doc = "Values that can be written to the field `ADC3RST`"]
pub type ADC3RSTW = AFIORSTW;
#[doc = r" Proxy"]
...
impl<'a> _ADC3RSTW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: ADC3RSTW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
