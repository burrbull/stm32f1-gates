...
impl W {
    ...
    #[doc = "Bits 24:31 - Attribute memory x databus HiZ time"]
    #[inline]
    pub fn atthiz(&mut self) -> _ATTHIZW {
        _ATTHIZW { w: self }
    }
    #[doc = "Bits 16:23 - Attribute memory x hold time"]
    #[inline]
    pub fn atthold(&mut self) -> _ATTHOLDW {
        _ATTHOLDW { w: self }
    }
    #[doc = "Bits 8:15 - Attribute memory x wait time"]
    #[inline]
    pub fn attwait(&mut self) -> _ATTWAITW {
        _ATTWAITW { w: self }
    }
    #[doc = "Bits 0:7 - Attribute memory x setup time"]
    #[inline]
    pub fn attset(&mut self) -> _ATTSETW {
        _ATTSETW { w: self }
    }
}
